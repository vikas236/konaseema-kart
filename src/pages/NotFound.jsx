  ...
  return (
    <div className="mx-auto flex items-center justify-center">
      ...
      >
        <defs>
          <path
            className="fundo animate-scales"
            id="prefix__a"
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <g transform="translate(-448 -157) translate(448 157)">
            ...
            />
            <g className="paes">
              <g className="pao-baixo animate-rotatepao">
                <path
                  fill="#FBB965"
              ...
              <g className="pao-cima animate-rotatepaoFast">
                <path
                  fill="#FBB868"
                ...
                <path
                  fill="#FFEAD4"
                  d="M45.508 13.114c-.368.549-.54 1.598-.503 2.445.017.392.297.604.45.287.143-.297.222-.617.303-.978.087-.387.197-.735.238-1.15.042-.44-.257-.95-.488-.604"
                  transform="translate(161 68)"
                />
              </g>
              <g className="olhos animate-olhos">
                <path
                  fill="#633"
                  d="M51.976 32.505c.27 2.748-1.735 5.197-4.476 5.47-2.748.274-5.199-1.732-5.476-4.48-.27-2.748 1.735-5.197 4.483-5.47 2.748-.274 5.192 1.733 5.469 4.48"
                />
                <path
                  fill="#633"
                  d="M93.976 28.505c.27 2.748-1.735 5.197-4.483 5.47-2.748.273-5.192-1.733-5.469-4.48-.27-2.748 1.735-5.197 4.483-5.47 2.748-.274 5.192 1.733 5.469 4.48"
                />
                <path
                  fill="#633"
                  d="M65.03 45.127c2.1-5.726 9.106-6.606 13.113-2.171.408.462-.277 1.204-.725.77-3.981-3.892-9.17-2.951-11.83 1.745-.187.333-.68-.002-.558-.344"
                  transform="translate(161 68)"
                />
              </g>
            </g>
            <g
              className="left-sparks animate-leftSparks"
              fillRule="nonzero"
              stroke="#979797"
              strokeLinecap="round"
              strokeWidth="1.8"
            ...
            <g
              className="right-sparks animate-leftSparks"
              fillRule="nonzero"
              stroke="#979797"
              strokeLinecap="round"
              strokeWidth="1.8"
...
function NotFound() {
  return (
    <div className="w-[calc(100dvw-40px)] flex flex-col justify-center items-center">
      <AnimatedSVG />
